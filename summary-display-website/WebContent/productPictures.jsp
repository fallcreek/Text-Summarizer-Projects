...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<link rel="stylesheet" href="css/productPictures.css" type="text/css" />
...
<div class="content">
	<div class="slide" id="slide">
		<div class="img-div">
			<img src="<s:property value="phoneInfo.pictureCoverURL"/>" title="正面" height="266px" width="150px"/>
			<img src="<s:property value="phoneInfo.pictureBackURL"/>" title="背面" height="266px" width="150px"/>
			<img src="<s:property value="phoneInfo.pictureProfileURL"/>" title="<s:property value="phoneInfo.pictureProfileURL"/>" height="266px" width="150px"/>
		</div>
		<div class="slide-btn">
...
var zBase = {
	...
	play:function(){
		this.slide.timer = setInterval(function(){
			...
			zBase.animate(zBase.img_div,zBase.config.direct,-zBase.config.index*150);
